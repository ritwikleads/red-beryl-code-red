          ...
          <>
            <div id="personalGreeting" className="mb-8 animate-fadeIn">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Thank you for scanning the QR code. Please tell us your prefered date and time of meeting.
          ...
          <div id="confirmation" className="mt-8 p-8 bg-[#FDFBEF] border-2 border-[#B2021F] rounded-xl shadow-lg transform transition-all duration-500 animate-slideUp">
            <div className="flex items-center mb-4">
              ...
              <div className="flex flex-col">
                ...
                <h2 className="text-3xl font-bold text-[#B2021F] ml-0 mt-1 whitespace-nowrap">{salutation ? `${salutation}` : ''}{firstName ? ` ${firstName}` : ''}{lastName ? ` ${lastName}` : ''}!</h2>
              </div>
            </div>
